...
export default function LungSlider() {
  ...
  useEffect(() => {
    const mm = (e: MouseEvent)  => { if (drag) update(e.clientX); };
    const mu = ()                => setDrag(false);
    const tm = (e: TouchEvent)  => { if (drag) update(e.touches[0].clientX); };
  ...
  return (
    <section style={{
      ...
      <div className="w">
        ...
        >
          {/* BASE — POLLUTED LUNG (full width) */}
          <Image
            src={POLLUTED}
            alt="Polluted lung — before Royal Swag"
            fill
            priority
          ...
          {/* TOP — HEALTHY LUNG (clipped by slider) */}
          <div style={{
            ...
            <div style={{
              ...
              <Image
                src={HEALTHY}
                alt="Healthy lung — after Royal Swag"
                fill
                priority
                sizes="(max-width: 768px) 100vw, 900px"
                style={{ objectFit: "cover", pointerEvents: "none" }}
          ...
          <div style={{
            ...
            <div style={{
              ...
              background: "#fff", boxShadow: "0 0 12px rgba(0,0,0,0.4)",
            }} />
            <div style={{
              ...
              <svg width="24" height="14" viewBox="0 0 24 14" fill="none">
                <path d="M8 1L2 7L8 13"  stroke="#4A6422" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M16 1L22 7L16 13" stroke="#4A6422" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
          </div>
        </div>
        ...
        <p style={{
          ...
          fontSize: 12, color: "#5C5647", opacity: 0.7, letterSpacing: 1,
        }}>← DRAG TO COMPARE →</p>
