...
import {
  buyButtonHover,
  buyButtonHoverTransition,
  buyButtonPulseKeyframes,
  buyButtonPulseTransition,
  buyButtonTap,
  buyButtonTapTransition,
  ...
  return (
    <motion.button
      ...
      whileHover={
        reduceMotion
          ? undefined
          : { ...buyButtonHover, transition: buyButtonHoverTransition }
      }
      whileTap={
        reduceMotion
          ? undefined
          : { ...buyButtonTap, transition: buyButtonTapTransition }
      }
      animate={reduceMotion ? undefined : buyButtonPulseKeyframes}
      transition={reduceMotion ? undefined : buyButtonPulseTransition}
      className={cn(
