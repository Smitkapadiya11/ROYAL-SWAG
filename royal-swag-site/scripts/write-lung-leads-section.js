...
const d = "d" + "iv";
const out = path.join(__dirname, "../src/components/admin/phase1/LungTestLeadsSection.tsx");
...
export default function LungTestLeadsSection() {
  ...
  return (
    ...
    >
      <${d} className="flex flex-col gap-4 border-b border-[rgba(200,210,190,0.4)] bg-white/30 px-6 py-4 lg:flex-row lg:items-center lg:justify-between">
        <h2 className="shrink-0 font-display text-xl font-bold text-[#324023]">
          Lung Test Leads
        </h2>
        <${d} className="flex flex-1 flex-wrap items-center justify-end gap-3">
          <input
            type="search"
      ...
      <${d} className="flex items-center justify-between border-t border-[rgba(200,210,190,0.4)] bg-white/20 px-6 py-3">
